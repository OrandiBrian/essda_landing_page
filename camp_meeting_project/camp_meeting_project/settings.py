...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-glui2ou@9-@3j2m)8ba(6r(b%q(v^v1oa3sj&$u^8z!f*bszcl')
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "https://8946-102-0-14-34.ngrok-free.app",
    "8946-102-0-14-34.ngrok-free.app"
]
...
INSTALLED_APPS = [
    ...
    'camp_meeting.apps.CampMeetingConfig',
    'corsheaders',
]
...
ROOT_URLCONF = 'camp_meeting_project.urls'
...
WSGI_APPLICATION = 'camp_meeting_project.wsgi.application'
